...
def brgn_og_maalte_graf(maaltefil1, maaltefil2, maaltefil3):
    ...
    x_new1 = np.linspace(x1[0], x1[-1], 100)
    x_new2 = np.linspace(x2[0], x2[-1], 100)
    x_new3 = np.linspace(x3[0], x3[-1], 100)
    ...
    plt.plot(x_new1, B_felt_helholtzs(x_new1, 2*R), label="Beregnet a=2R", color='r')
    plt.plot(x_new2, B_felt_helholtzs(x_new2, R), label="Beregnet a=R", color='b')
    plt.plot(x_new3, B_felt_helholtzs(x_new3, R/2), label="Beregnet a=R/2", color='g')
    ...
    #plt.savefig("helmot3.pdf")
    plt.show()
brgn_og_maalte_graf("helmot2_2R.txt", "helmot2_R.txt", "helmot2_R_2.txt")
...
def avvik_graf(maaltefil_2R, maaltefil_R, maaltefil_R_2):
    ...
    brgn_2R = B_felt_helholtzs(x1, 2*R)
    brgn_R = B_felt_helholtzs(x2, R)
    brgn_R_2 = B_felt_helholtzs(x3, R/2)
